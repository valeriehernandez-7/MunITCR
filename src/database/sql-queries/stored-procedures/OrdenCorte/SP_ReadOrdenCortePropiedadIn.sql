...
/* 
	@proc_name SP_ReadOrdenCortePropiedadIn
	@proc_description
	@proc_param inPropiedadLote
	@proc_param outResultCode Procedure return value
	@author <a href="https://github.com/valeriehernandez-7">Valerie M. Hernández Fernández</a>
*/
CREATE OR ALTER PROCEDURE [SP_ReadOrdenCortePropiedadIn]
		...
		IF (@inPropiedadLote IS NOT NULL)
			BEGIN
				SELECT 
					...
					[F].[FechaVencimiento] AS [VencimientodeFactura],
					(CASE 
						WHEN [OC].[Activo] = 0 THEN 'Realizado'
						WHEN [OC].[Activo] = 1 THEN 'Pendiente' 
					END) AS [EstadodeReconexion]
